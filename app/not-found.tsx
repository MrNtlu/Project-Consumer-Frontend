    ...
    return (
        <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center">
                ...
                <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Not Available on Web 😔</h1>
                <p className="mt-6 text-2xl leading-7 text-gray-700">You need to download the application to see the contents.</p>
