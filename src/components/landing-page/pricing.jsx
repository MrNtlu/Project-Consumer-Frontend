...
export default function Pricing() {
    return (
        <section id="pricing" className="text-gray-600 dark:text-gray-300 body-font py-24 bg-gray-50 dark:bg-gray-900">
            <div className="container px-8 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 flex flex-col">
                        ...
                        <p className="text-5xl font-bold text-gray-900 dark:text-white mt-2">Free</p>
                        ...
                        <div className="mt-auto pt-8">
                            <button className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold py-3 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                                Get Started Free
                            </button>
                    ...
                    {/* Premium Plan */}
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 flex flex-col border-2 border-blue-500 relative">
                        ...
                        <p className="text-5xl font-bold text-gray-900 dark:text-white mt-2">$0.99<span className="text-lg font-medium text-gray-500">/mo</span></p>
                        <ul className="mt-8 space-y-4 text-gray-600 dark:text-gray-300 flex-grow">
                            <li className="flex items-center">
                    ...
                    {/* Annual Plan */}
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-xl shadow-lg p-8 flex flex-col border-2 border-green-500 relative">
                        ...
                        <p className="text-5xl font-bold text-gray-900 dark:text-white mt-2">$9.99<span className="text-lg font-medium text-gray-500">/year</span></p>
                        <ul className="mt-8 space-y-4 text-gray-600 dark:text-gray-300 flex-grow">
                            <li className="flex items-center">
                                <BsCheck2Circle className="text-green-500 mr-3 w-5 h-5 flex-shrink-0" />
